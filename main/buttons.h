...
void checkButtons(void); //checks buttons, makes changes based on buttons

void readButtons(void); //reads buttons to a mailbox

void button_func(void); //posts to button_task every 5ms, called by clock0
